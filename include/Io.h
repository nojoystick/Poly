...
// // pins for IO
// const int io[] = {  
//   MA_VOL_IN, MA_RAT_IN, WF_MI1_IN, WF_MI2_IN, NO_MIX_IN, BO_MIX_IN, FI_RES_IN, FI_DEP_IN, LF_DEP_IN, VI_DEP_IN, EN_ATT_IN, EN_DEC_IN, EN_SUS_IN, EN_REL_IN,
//   WF_SEL_SW, NO_SEL_SW, BO_SEL_SW, FI_SEL_SW, LF_SEL_SW, VI_SEL_SW, EN_SEL_SW, RATE_LED, WF_SW1_SW, WF_SW2_SW, WF_SW3_SW
// };
